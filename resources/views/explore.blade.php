            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="explore-fields">
                        <input type="search" name="search" placeholder="Search..." class="form-control" id="">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="explore-fields">
                       <select name="" class="form-control" id="">
                         <option selected>All Education Level</option>
                ...
                <div class="col-md-2">
                    <div class="explore-fields">
                        <select name="" class="form-control" id="">
                            <option selected>All Stream</option>
                ...
                <div class="col-md-3">
                    <div class="explore-fields">
                        <select name="" class="form-control" id="">
                            <option selected>All Mode OF Education</option>
