...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="pull-left">
            <h4 class="text-blue h4">Add Abilities</h4>
        </div>
    ...
    @endif
    <form method="post" action="{{url('admin/save-abilities')}}">
        {{ csrf_field() }}
    ...
    <div class="pb-20">
        <table class="data-table table stripe hover nowrap">
            ...
            <tbody>
                ...
                <tr>
                    <td class="table-plus">{{$ability->name}}</td>
                    <td>{{$ability->slug}}</td>
                    <td> {{ Str::limit($ability->description,200)}}</td>
