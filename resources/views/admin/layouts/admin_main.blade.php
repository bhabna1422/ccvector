...
<body>
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        ...
                        <form method="POST" action="{{ route('admin.logout') }}">
                            ...
                            onclick="event.preventDefault();
                                        this.closest('form').submit();"><i class="dw dw-logout"></i>  {{ __('Log Out') }}</a>
	...
	<div class="left-side-bar">
		<div class="brand-logo">
			<a href="index.html">
				...
				<img src="{{asset("front/img/vector-logooo12.png")}}" alt="" class="light-logo" />
			</a>
				...
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon bi bi-textarea-resize"></span><span class="mtext">My career</span>
						</a>
						<ul class="submenu">
							<li><a href="form-basic.html">All my career</a></li>
                            <li class="{{ Route::is('admin/add-new') ? 'active' : '' }}"><a href="{{route('admin.add-new')}}">Add New</a></li>
							<li>
								<a href="{{route('admin.educational-level')}}">Educational Level</a>
							</li>


							<li><a href="{{route('admin.stream')}}"> Stream</a></li>
							<li><a href="{{route('admin.mode-of-education')}}">Mode of Education</a></li>
							<li><a href="{{route('admin.future-trend')}}">Future Trend</a></li>
							<li><a href="image-cropper.html">I want to be a</a></li>
							<li><a href="{{route('admin.abilities')}}">Abilities</a></li>
                            <li><a href="{{route('admin.interest')}}"> Interest</a></li>
							<li><a href="{{route('admin.knowledge')}}">Knowledge</a></li>
							<li><a href="{{route('admin.skills')}}">Skills</a></li>
							<li><a href="{{route('admin.work-activities')}}">Work Activities</a></li>
							<li><a href="{{route('admin.work-context')}}">Work Context</a></li>
                            <li><a href="{{route('admin.work-types')}}">Work Types</a></li>
							<li><a href="{{route('admin.work-value')}}">Work Value</a></li>
							<li><a href="image-cropper.html">Personality</a></li>
							<li><a href="image-dropzone.html">Your Learning Style</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon bi bi-table"></span><span class="mtext">Scholarship</span>
						</a>
						<ul class="submenu">
							<li><a href="basic-table.html">All Scholarship</a></li>
							<li><a href="datatable.html">Add new</a></li>
                            <li><a href="datatable.html">State</a></li>
						</ul>
					</li>
					{{-- <li>
	...
	<script src="{{ asset('admin/scripts/dashboard3.js')}}"></script>
