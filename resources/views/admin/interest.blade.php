...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="pull-left">
            <h4 class="text-blue h4">Add Interest</h4>
        </div>
    ...
    @endif
    <form method="post" action="{{url('admin/save-interest')}}">
        {{ csrf_field() }}
...
<div class="card-box mb-30">
    <div class="pd-20">
        <h4 class="text-blue h4">List Of Interest</h4>
        ...
        <table class="data-table table stripe hover nowrap">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$interest->slug}}</td>
                    <td> {{ Str::limit($interest->description,200)}}</td>
