...
<div class="pd-20 card-box mb-30">
    <div class="clearfix">
        <div class="pull-left">
            <h4 class="text-blue h4">Add Future Trend</h4>
        </div>
    ...
    @endif
    <form method="post" action="{{url('admin/save-future-trend')}}">
        {{ csrf_field() }}
    ...
    <div class="pb-20">
        <table class="data-table table stripe hover nowrap">
            ...
            <tbody>
                ...
                <tr>
                    <td class="table-plus">{{$future->name}}</td>
                    <td>{{$future->slug}}</td>
                    <td> {{ Str::limit($future->description,200)}}</td>
